...
const log = (0, jobseeker_shared_1.winstonLogger)(`${config_1.config.ELASTIC_SEARCH_URL}`, 'emailConsumer', 'debug');
function consumeAuthEmailMessages(channel) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            log.log('error', 'NotificationService error consumeAuthEmailMessages() method error: ', error);
        }
    });
}
